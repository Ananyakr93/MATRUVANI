...
Usage:
    from src.screening import compute_ams
...
# ---------------------------------------------------------------------------
# Legacy 20-phrase lexicon (from original lexicon.py)
# Preserved for backward compatibility with existing screening route.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Legacy lexicon hit counter (from original lexicon.py)
# ---------------------------------------------------------------------------
